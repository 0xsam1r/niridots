return {
 ...
 ██████  █████████████████████ ████ █████ █████ ████ ██████ 
      ...
      sections = {
        ...
        { icon = " ", key = "p", desc = "Projects", gap=1, indent=1, padding=1, action = ":lua Snacks.picker.projects()" },       
  ...
  keys = {
    ...
    { "<leader>tc", function() Snacks.picker.colorschemes() end, desc = "[T]oggle [C]olorschemes" },
    {
      "<leader>/",
      function()
        Snacks.picker.lines({
